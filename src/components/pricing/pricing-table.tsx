        ...
        subscriptionPlans.length > 0 && (
          <div className="flex justify-center">
            <ToggleGroup
              ...
              className="border-2 border-[var(--color-bunny-border)] rounded-xl p-1 bg-[var(--color-bunny-cream)]"
            >
              {hasMonthlyOption && (
                <ToggleGroupItem
                  value="month"
                  className={cn(
                    'px-4 py-2 cursor-pointer text-sm rounded-lg font-medium',
                    'data-[state=on]:bunny-gradient data-[state=on]:text-white data-[state=on]:border-none'
                  )}
                >
                  {t('monthly')}
                </ToggleGroupItem>
