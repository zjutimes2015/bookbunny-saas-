...
export enum Routes {
  ...
  HaiTang = 'https://haitang.app',

  Deals = '/deals/XMAS2025',
  Backlinks = '/backlinks',
  Products = '/products',
  ProductsSubmit = '/products/submit',
  AdminProducts = '/admin/products',
  AdminBacklinks = '/admin/backlinks',
  AdminProductDeals = '/admin/deals',
...
export const protectedRoutes = [
  ...
  Routes.Products,
  Routes.AdminUsers,
  Routes.AdminProductDeals,
  Routes.AdminBacklinks,
  Routes.AdminBooks,
...
export const DEFAULT_LOGIN_REDIRECT =
  websiteConfig.routes.defaultLoginRedirect ?? Routes.Products;
